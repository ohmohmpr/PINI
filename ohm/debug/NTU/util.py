...
def plot_everything(pini_data, lio_ekf_data, title, start_time_idx, end_time_idx):
  ...
  plot_delta_x(pred_lio_ekf_data, None, pred_pini_data, None, title, start_time_idx, end_time_idx, 'state')
  plot_delta_x(delta_x_lio_ekf_data, None, delta_x_pini_data, None, title, start_time_idx, end_time_idx, 'delta_x')
  plot_delta_x(cov_lio_ekf_data, None, cov_pini_data, None, title, start_time_idx, end_time_idx, 'cov')
  plot_delta_x(n_lio_ekf_data, None, n_pini_data, None, title, start_time_idx, end_time_idx, 'N')




def plot_delta_x(pred_data_LIO_EKF, update_data_LIO_EKF, pred_data_PINI, update_data_PINI, title, start_time_idx, end_time_idx, del_name):
  ...
  figure, axis = plt.subplots(3, 1, sharex=True, figsize=(12, 9))
